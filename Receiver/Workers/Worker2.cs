...
public class Worker2 : IHostedService, IDisposable
{
    ...
    public Worker2(EventReceiver eventReceiver, ILogger<Worker2> logger)
    {
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        ...
        {
            const string queueName = $"Pipeline.{RoutingKeys.RoutingKeyWorker2}";
            _eventReceiver.SubscribeQueue(queueName, RoutingKeys.RoutingKeyWorker2, MessageReceivedAsync);
        }, cancellationToken);
