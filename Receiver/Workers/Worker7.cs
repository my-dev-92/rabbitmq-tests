...
public class Worker7 : IHostedService, IDisposable
{
    ...
    public Worker7(EventReceiver eventReceiver, ILogger<Worker7> logger)
    {
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        ...
        {
            const string queueName = $"Pipeline.{RoutingKeys.RoutingKeyWorker7}";
            _eventReceiver.SubscribeQueue(queueName, RoutingKeys.RoutingKeyWorker7, MessageReceivedAsync);
        }, cancellationToken);
