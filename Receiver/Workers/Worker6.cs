...
public class Worker6 : IHostedService, IDisposable
{
    ...
    public Worker6(EventReceiver eventReceiver, ILogger<Worker6> logger)
    {
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        ...
        {
            const string queueName = $"Pipeline.{RoutingKeys.RoutingKeyWorker6}";
            _eventReceiver.SubscribeQueue(queueName, RoutingKeys.RoutingKeyWorker6, MessageReceivedAsync);
        }, cancellationToken);
