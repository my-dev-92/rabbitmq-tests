...
public class Worker3 : IHostedService, IDisposable
{
    ...
    public Worker3(EventReceiver eventReceiver, ILogger<Worker3> logger)
    {
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        ...
        {
            const string queueName = $"Pipeline.{RoutingKeys.RoutingKeyWorker3}";
            _eventReceiver.SubscribeQueue(queueName, RoutingKeys.RoutingKeyWorker3, MessageReceivedAsync);
        }, cancellationToken);
