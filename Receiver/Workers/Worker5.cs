...
public class Worker5 : IHostedService, IDisposable
{
    ...
    public Worker5(EventReceiver eventReceiver, ILogger<Worker5> logger)
    {
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        ...
        {
            const string queueName = $"Pipeline.{RoutingKeys.RoutingKeyWorker5}";
            _eventReceiver.SubscribeQueue(queueName, RoutingKeys.RoutingKeyWorker5, MessageReceivedAsync);
        }, cancellationToken);
